  ...
  return (
    ...
    <div className="flex items-center gap-3 h-full overflow-visible">
      ...
      <div className="flex items-center gap-3 sm:gap-5">
        <div className="app-navbar-metrics hidden sm:flex items-center gap-4 text-sm font-semibold" style={{ color: '#6B7A99' }}>

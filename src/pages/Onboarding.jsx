      ...
      <div className="min-h-screen flex items-center justify-center px-6 py-10" style={{ background: '#F4F7FB' }}>
        <div className="w-full max-w-4xl grid lg:grid-cols-[0.8fr_1.2fr] overflow-hidden rounded-[2rem]" style={{ background: 'white', boxShadow: '0 24px 80px rgba(10,35,66,0.14)' }}>
          <div className="hidden lg:flex flex-col justify-between p-10" style={{ background: '#0A2342' }}>
            <div><img src="/datakwest_logo_lockup.png" alt="DataKwest logo" className="h-12 w-52 object-contain object-left" /><p className="mt-8 text-xs font-bold uppercase tracking-[0.24em]" style={{ color: '#D4AF37' }}>Datakwest AI</p><h2 className="mt-3 text-3xl font-bold leading-tight text-white">Your next chapter is taking shape.</h2></div>
  ...
  return (
    <div className="min-h-screen" style={{ background: '#F4F7FB' }}>
      <header className="flex items-center justify-between px-6 py-5 sm:px-10">
        <div className="flex items-center gap-3"><img src="/datakwest_logo_lockup.png" alt="DataKwest logo" className="h-12 w-52 object-contain object-left" /><div><p className="text-sm font-black tracking-tight" style={{ color: '#0A2342' }}>DATAKWEST</p><p className="text-[10px] font-semibold uppercase tracking-[0.18em]" style={{ color: '#8391A7' }}>Career operating system</p></div></div>

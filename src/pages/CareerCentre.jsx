...
<section className="mt-8 rounded-[2rem] border p-7" style={{ borderColor: '#E2EAF3', background: 'white' }} aria-labelledby="readiness-story-title"><div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between"><div><p className="text-xs font-bold uppercase tracking-[0.18em]" style={{ color: '#9A7610' }}>Your readiness story</p><h2 id="readiness-story-title" className="mt-2 text-2xl font-black">A clear path from evidence to opportunity.</h2><p className="mt-3 max-w-2xl text-sm leading-6" style={{ color: '#6B7A99' }}>Your score is not a label or a promise. It is a server-computed snapshot of the evidence you have demonstrated so far.</p></div><span className="rounded-full px-3 py-2 text-xs font-black" style={{ background: '#FFF9E8', color: '#8A6500' }}>{readiness.band || 'starting'} · {score}/100</span></div><div className="mt-6 grid gap-3 md:grid-cols-3"><div className="rounded-2xl p-4" style={{ background: '#F4F7FB' }}><p className="text-xs font-black uppercase tracking-wide" style={{ color: '#8290A5' }}>What changed</p><p className="mt-2 text-sm font-bold">{evidence.reviewed_projects || 0} reviewed project{evidence.reviewed_projects === 1 ? '' : 's'} and {evidence.completed_interviews || 0} completed interview{evidence.completed_interviews === 1 ? '' : 's'} are currently counted.</p></div><div className="rounded-2xl p-4" style={{ background: '#F4F7FB' }}><p className="text-xs font-black uppercase tracking-wide" style={{ color: '#8290A5' }}>Why it matters</p><p className="mt-2 text-sm font-bold">Reviewed evidence demonstrates what you can explain and apply—not only what you have viewed.</p></div><div className="rounded-2xl p-4" style={{ background: '#F4F7FB' }}><p className="text-xs font-black uppercase tracking-wide" style={{ color: '#8290A5' }}>What to do next</p><p className="mt-2 text-sm font-bold">{actions[0]?.title || 'Create your first verified project or practice session.'}</p></div></div></section>

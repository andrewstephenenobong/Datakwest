...
export default function Dashboard() {
  ...
  const skillAdded = searchParams.get('skill-added') === '1'
  const addedSkillTitle = searchParams.get('skill') || 'Your selected skill'
  ...
  return (
    <div className="dashboard-page min-h-screen" style={{ background: '#F5F7FA' }}>
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        {skillAdded && <section className="mb-6 flex items-center gap-4 rounded-2xl border p-5" style={{ borderColor: '#9DD7B2', background: '#E8F5E9' }} aria-labelledby="skill-added-title"><div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full" style={{ background: '#216E46', color: '#fff' }}>✓</div><div className="min-w-0"><p className="text-xs font-black uppercase tracking-[.16em]" style={{ color: '#216E46' }}>Skill added successfully</p><h2 id="skill-added-title" className="mt-1 text-lg font-black" style={{ color: '#0A2342' }}>{addedSkillTitle} is now active for today.</h2><p className="mt-1 text-sm leading-6" style={{ color: '#4B6385' }}>Your starting level was saved. Your next lessons and missions will use this skill while your other learning paths remain safe.</p></div></section>}

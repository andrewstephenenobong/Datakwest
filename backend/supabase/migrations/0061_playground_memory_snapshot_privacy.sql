-- 0061_playground_memory_snapshot_privacy.sql
-- Never expose the hidden Memory Cards deck to clients.
...
begin
  ...
  if v_room.game_key = 'memory_cards' then
...
comment on function public.playground_room_snapshot(uuid) is 'Returns a member-safe room view. Memory Cards hides all deck values except revealed or matched positions.';
